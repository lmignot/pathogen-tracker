...
class EditTextExtensionTest {
  ...
  private val textInput: EditText = EditText(InstrumentationRegistry.getContext())
  ...
  fun should_return_default_value() {
    assertEquals(textInput.asIntOrDefault(TEST_DEFAULT_NUM), TEST_DEFAULT_NUM)
  }

  @Test
  fun should_return_positive_value() {
    textInput.setText(TEST_POSITIVE_NUM.toString())
    assertEquals(textInput.asIntOrDefault(TEST_DEFAULT_NUM), TEST_POSITIVE_NUM)
  }

  @Test
  fun should_return_negative_value() {
    textInput.setText(TEST_NEGATIVE_NUM.toString())
    assertEquals(textInput.asIntOrDefault(TEST_DEFAULT_NUM), TEST_NEGATIVE_NUM)
  }

  @Test
  fun should_return_zero_value_when_no_args() {
    assertEquals(textInput.asIntOrDefault(), TEST_NOARGS_NUM)
  }
